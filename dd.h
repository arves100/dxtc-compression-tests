...
// Create surfaces
extern bool DDCreateSurfaces(bool bFullScreen, int width, int height, int bpp);
// Destroy surfaces
...
extern void DDPutPixel( LPDIRECTDRAWSURFACE7 pDDS, int x, int y, int r, int g, int b );
// Create color from RGB triple
extern unsigned int CreateRGB( int r, int g, int b );
// Clear a surface area with black
extern void DDClear( LPDIRECTDRAWSURFACE7 pDDS, int x1, int y1, int x2, int y2 );
// Double buffering flip
extern void DDFlip(int w, int h);
// Blit surfaces
extern bool DDBlt(LPDIRECTDRAWSURFACE7 pSrc, int srcX, int srcY, int srcW, int srcH,
	LPDIRECTDRAWSURFACE7 pDst, int dstX, int dstY, int dstW, int dstH);
// compressed texture
extern LPDIRECTDRAWSURFACE7 DDCreateDXTSurface(int w, int h, int fcc);
